...
const BLACKBOX_CASES = [
  ...
  },
  {
    ...
    aboard: 239,
    fatalities: 239,
    fatalitiesLabel: "239 presumed lost",
  ...
  },
  {
    ...
    intensity: 9,
    excerpt: "A worn jackscrew stripped its threads mid-flight and took all pitch control with it. Two pilots kept flying an aircraft that could no longer be flown.",
    aboard: 88,
    fatalities: 88,
  ...
  },
  {
    ...
    intensity: 9,
    excerpt: "A fire spread above the cockpit ceiling of a calm, working crew who ran the checklist exactly as written and never knew how little time they had.",
    aboard: 229,
    fatalities: 229,
