...
(function () {
  ...
  var CASE_FILES_INDEX = [
    ...
    { title: 'The Hijacking That Ran Out Of Fuel', tag: 'Black Box Files', url: 'ethiopian-airlines-961.html' },
    ...
    { title: 'They Shut Down The Wrong Engine', tag: 'Black Box Files', url: 'kegworth-air-disaster.html' },
